...
export const ProjectHubFeature = () => {
  const projects = [
    { name: "Website Redesign", color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20", members: 3 },
    { name: "Mobile App", color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20", members: 5 },
    { name: "Marketing Q4", color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20", members: 2 },
    { name: "Internal Tools", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20", members: 4 },
  ];
