...
import { Task, TaskStatus, Project, Priority, TaskTag } from '@/types/task';
...
function DroppableColumn({ id, title, tasks, onUpdateTask, onDeleteTask, onEditTask, onArchiveTask, isHighlighted }: DroppableColumnProps) {
...
export function KanbanBoard({ project, tasks, onAddTask, onUpdateTask, onDeleteTask, onMoveTask, onEditTask, onArchiveTask }: KanbanBoardProps) {
